...
public class Room implements Serializable
{
	...
	public void reserveRoom(String newDate,
			me.dokollari.college.manager.models.Room reservRoom)
		...
		JOptionPane.showMessageDialog(null, reservRoom.getRoomTitle()
	...
	public void cancelReservaion(me.dokollari.college.manager.models.Room cancRes) {
		if (reservedRoomList.containsKey(cancRes.getDateTitle())) {
			...
			JOptionPane.showMessageDialog(null, "Reservation Canceled", "Success",
	...
	public String displayDateReservedForThisRoom() {
		String list = "";
		for (Map.Entry<String, me.dokollari.college.manager.models.Room> e : reservedRoomList
				.entrySet())
			list += e.getValue() + "\n";
		return list;
	}
	...
	public boolean equals(Object object) {
		...
		if (other.getDateTitle() == null) { // for creating rooms. -->arrayList
														// will use it(college_.roomList)
			if (!(roomTitle == null ? other == null : roomTitle
					.equals(other.roomTitle)))
				return false;
		}
		return true;
	}

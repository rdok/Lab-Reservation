...
public class Course implements Serializable
{
	...
	public String displayClasslist() {
		String list = "";
		for (Map.Entry<Integer, me.dokollari.college.manager.models.Student> e : students
				.entrySet())
			list += e.getValue() + "\n";
		return list;
	}
	...
	public String toString() {
		...
		return String.format("%-" + (maxLengthCourseName + 3) + "sLimit:%-5d",
				getCourseTitle(), getStudentLimit());
	}
	...
	public boolean equals(Object object) {
		...
		if (!(courseTitle == null ? other.courseTitle == null : courseTitle
				.equals(other.courseTitle))) {
			return false;
		}
		return true;
	}
